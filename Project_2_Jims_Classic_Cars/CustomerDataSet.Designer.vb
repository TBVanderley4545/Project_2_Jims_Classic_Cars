...
Partial Public Class CustomerDataSet
    ...
    Partial Public Class CustomersDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddCustomersRow(ByVal LastName As String, ByVal FirstName As String, ByVal Phone As String) As CustomersRow
            Dim rowCustomersRow As CustomersRow = CType(Me.NewRow,CustomersRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, LastName, FirstName, Phone}
    ...
    Partial Public Class CustomersTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Customers] WHERE (([CustomerID] = @Original_CustomerID) AND (["& _ 
                "LastName] = @Original_LastName) AND ([FirstName] = @Original_FirstName) AND ([Ph"& _ 
                "one] = @Original_Phone))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Customers] ([LastName], [FirstName], [Phone]) VALUES (@LastNam"& _ 
                "e, @FirstName, @Phone);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT CustomerID, LastName, FirstName, Phone FROM Cust"& _ 
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Customers] SET [LastName] = @LastName, [FirstName] = @FirstName, [P"& _ 
                "hone] = @Phone WHERE (([CustomerID] = @Original_CustomerID) AND ([LastName] = @O"& _ 
                "riginal_LastName) AND ([FirstName] = @Original_FirstName) AND ([Phone] = @Origin"& _ 
                "al_Phone));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT CustomerID, LastName, FirstName, Phone FROM Customers WHERE "& _ 
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.Project_2_Jims_Classic_Cars.My.MySettings.Default.CustomerConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT CustomerID, LastName, FirstName, Phone FROM dbo.Customers"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As CustomerDataSet.CustomersDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As CustomerDataSet.CustomersDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
        ...
        Public Overloads Overridable Function Delete(ByVal Original_CustomerID As Integer, ByVal Original_LastName As String, ByVal Original_FirstName As String, ByVal Original_Phone As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal LastName As String, ByVal FirstName As String, ByVal Phone As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal LastName As String, ByVal FirstName As String, ByVal Phone As String, ByVal Original_CustomerID As Integer, ByVal Original_LastName As String, ByVal Original_FirstName As String, ByVal Original_Phone As String, ByVal CustomerID As Integer) As Integer
            If (LastName Is Nothing) Then
                Throw New Global.System.ArgumentNullException("LastName")
            Else
            ...
            End If
            Me.Adapter.UpdateCommand.Parameters(7).Value = CType(CustomerID,Integer)
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal LastName As String, ByVal FirstName As String, ByVal Phone As String, ByVal Original_CustomerID As Integer, ByVal Original_LastName As String, ByVal Original_FirstName As String, ByVal Original_Phone As String) As Integer
            Return Me.Update(LastName, FirstName, Phone, Original_CustomerID, Original_LastName, Original_FirstName, Original_Phone, Original_CustomerID)
        End Function
    End Class
